...
export function itemPlaceholder(content: TemplateResult | HTMLElement | string, icon?: TemplateResult, click?: () => void) {
    return html`<div @click=${() => (click ? click() : undefined)} class="bg-muted text-muted-fg fill-muted-fg, px-4 py-2 rounded flex items-center">
